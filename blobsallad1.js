  ...
  function Blob(x, y, radius, numPointMasses)
  {
    ...
    this.drawBody = function(ctx, scaleFactor)
    {
      ...
      {
        ctx.fillStyle = "#CCFFCC"; //тут замена цвета
      }
      else 
      {
        ctx.fillStyle = "#FFFFFF"; 
    ...
    this.draw = function(ctx, scaleFactor)
    {
	  ...
	  this.drawEars(ctx, scaleFactor); //рисует уши
	  this.drawFace(ctx, scaleFactor); //рисует глаза и рот
  ...
  function draw()
  {
    ...
    ctx.strokeStyle = "#009900"; //цвет обводки
	ctx.lineWidth = 10; //толщина обводки
	ctx.strokeRect(0, 0, width, height); //обводка области
  ...
  {  
    ...
    document.onkeydown = function(event) //код, отвечающий за привязку к клавиатуре
    {
      var keyCode; 
      ...
      switch(keyCode)
      {
        ...
        // join 'j' объединение объектов, буква J
        case 74:
          blobColl.join(); 
          break;  
        
        // split 'h' деление объекта H
        case 72: 
          blobColl.split(); 
          break; 
          
        // toggle gravity 'g' включение гравитации, буква G
        case 71: 
          toggleGravity(); 
          break; 
    ...
    }  //конец кода, отвечающего за привязку к клавиатуре
